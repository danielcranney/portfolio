      ...
      <div className="h-screen container mx-auto z-30">
          ...
          <div className="flex w-full mt-8">
            <div className="w-3/5 pr-8 text-xl flex flex-col">
              ...
              <p className="text-lg">
                ...
                purus orci, cursus eget tortor scelerisque, posuere mattis
                lectus. Mauris fermentum condimentum ipsum id facilisis.
              </p>
              <p className="text-lg">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
                est urna, dignissim et mauris id, ultrices finibus ligula. Nulla
            ...
            <div className="w-2/5 pl-8 h-full flex mt-auto">
              <Image
        ...
        <section className="p-24 w-full flex flex-col">
          ...
          <div className="flex w-full mt-8 flex-wrap pr-4">
            {/* HTML */}
            <div className="w-1/5 items-center flex flex-col justify-center p-3">
            ...
            {/* CSS */}
            <div className="w-1/5 items-center flex justify-center p-3 flex-col">
              <div className="w-24 h-24 group">
                <svg viewBox="0 0 128 128">
                  <path
                    className="text-white fill-current opacity-20 group-hover:opacity-100 transition-all duration-200 group-hover:text-brand"
            ...
            {/* Javascript */}
            <div className="w-1/5 items-center flex-col flex justify-center p-3">
              <div className="w-24 h-24 group">
                <svg viewBox="0 0 128 128">
                  <path
                    className="text-white fill-current opacity-20 group-hover:opacity-100 transition-all duration-200 group-hover:text-brand"
